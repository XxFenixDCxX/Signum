    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteSearch.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (selectedSigno != null) {
                ...
                String selectedSignoNombre = selectedSigno.getTitulo();

                Toast.makeText(DiccionaryActivity.this, "Seleccionaste: " + selectedSignoNombre + " con ID : "+selectedSignoId, Toast.LENGTH_SHORT).show();
        ...
        bottomNavigationView.setOnItemSelectedListener(
                item -> {
                    ...
                    if (id == R.id.diccionary) {
                        ...
                        // Lógica cuando se selecciona "Practice"
