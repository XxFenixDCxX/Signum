...
public class OnePractiseActivity extends AppCompatActivity {
        ...
        if (opcionSeleccionada == posicionCorrecta) {
           ...
           /*
            switch (opcionSeleccionada) {
                case 1:
                    btnOpcion1.setBackgroundResource(R.color.blue_200);
                    break;
                case 2:
                    btnOpcion2.setBackgroundResource(R.color.blue_200);
                    break;
                case 3:
                    btnOpcion3.setBackgroundResource(R.color.blue_200);
                    break;
                case 4:
                    btnOpcion4.setBackgroundResource(R.color.blue_200);
                    break;
            }*/
    ...
    private void mostrarSiguientePregunta() {
        ...
        if (signosList != null && !signosList.isEmpty()) {
            ...
            Log.i("Signo correcto", "titulo: " + signoCorrecto.getTitulo());
    ...
    private void asignarOpciones(Signo signo) {
        ...
        Log.d("Asignar Opcion", "Pos "+posicionCorrecta);
    ...
    private String obtenerRespuestaIncorrecta(Signo signo) {
        ...
        if (signosExceptoActual.size() > 4) {
            // Lógica para seleccionar aleatoriamente entre las palabras restantes
